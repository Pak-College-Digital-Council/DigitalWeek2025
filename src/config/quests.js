export const quests = {
  1: {
    ...
    successClippyMessages: [
        ...
        { text: "I'll be in touch. See you soon!", interactive: true }
    ],
    introClippyMessages: [
  ...
  2: { 
    ...
    introClippyMessages: [
        { text: "Alright, you've opened the File Explorer application. Smart move!", interactive: true },
  ...
  3: {
    id: 3,
    title: "Email Phishing Challenge",
    type: "email_phishing",
    data: {
      emails: [
        {
        ...
        },
        {
          ...
          hints: [
            ...
            { id: "pn-font-style", query: "[data-hint-id='pn-font-style']", message: "The use of Comic Sans font and garish colors is highly unprofessional and not typical of a real company's newsletter." },
        ...
        },
        {
          ...
          hints: [
            ...
            { id: "pkg-footer", query: ".email-flexible-footer__additionalinfo--center span.text-primary", message: "The footer contains correct and verifiable school contact information with proper styling, reinforcing its authenticity as an official school communication." }
          ]
        }
      ],
      successEmail: {
    ...
    clippyMessages: {
      desktopIntro: [
        { text: "Hey again! L0GIC's next trick involves phishing emails. Devious!", interactive: true },
        { text: "I've added a new Email Client to your desktop. That's where you'll tackle this.", interactive: true },
        { text: "I'm highlighting it for you now. Double-click it when you're ready to start!", interactive: true, onComplete: null }
      ],
      emailClientIntro: [
        { text: "Welcome to your SecureMail Client!", interactive: true },
        { text: "Your mission is to identify the THREE phishing emails from the list in your inbox.", interactive: true },
        { text: "Look for the usual red flags: suspicious links, urgent demands for personal information, unexpected attachments, poor grammar, or anything that just feels 'off'.", interactive: true },
        { text: "Select the three emails you believe are phishing attempts using the checkboxes next to each one.", interactive: true },
        { text: "Once you've made your selections, click the 'Report Phishing' button.", interactive: true },
        { text: "If you incorrectly report a legitimate email, I'll explain why it was safe, and you'll need to re-evaluate and try again. Good luck, agent!", interactive: true }
      ],
      success: [
        { text: "Brilliant! You've correctly identified all three phishing emails!", interactive: true },
        { text: "L0GIC underestimated your keen eye for digital deception.", interactive: true }
      ],
      feedback: {
        incorrectReport: [
          { text: "Not quite. At least one of the emails you reported as phishing is actually legitimate, or one of the actual phishing emails wasn't reported. Review the emails carefully and try again!", interactive: true },
          { text: "Remember to look for unusual sender addresses, links that don't match the supposed source, urgent demands, and unexpected attachments or requests.", interactive: true }
        ],
        genericError: [
            { text: "Hmm, that selection isn't quite right. Double-check each email for those tricky phishing signs and select exactly three.", interactive: true}
        ],
        selectThree: [
          { text: "Please select exactly THREE emails before reporting.", interactive: true }
        ]
      },
      congratulations: [
        { text: "You've found the final piece of the puzzle! I've just sent you an email with the details.", interactive: true },
        { text: "Check your inbox for a message from me. That 'reasoning string' is crucial!", interactive: true },
        { text: "Fantastic work, agent! You've gathered all the clues needed to confront L0GIC!", interactive: true }
      ],
      hintSystemActivation: [
        { text: "Hint mode activated! Click on parts of an email like the sender, subject, or links to get clues.", interactive: true },
        { text: "I'll point out suspicious things or confirm safe elements. Toggle the switch again to turn hints off.", interactive: true }
      ],
      hintSystemDeactivation: [
        { text: "Hint mode deactivated.", interactive: true }
      ]
    }
  }
};
